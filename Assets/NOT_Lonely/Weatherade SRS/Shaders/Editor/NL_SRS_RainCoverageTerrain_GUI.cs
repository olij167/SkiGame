namespace NOT_Lonely.Weatherade.ShaderGUI
{
    ...
    public class NL_SRS_RainCoverageTerrain_GUI : UnityEditor.ShaderGUI, ITerrainLayerCustomUI
    {
        ...
        public NL_SRS_RainCoverageTerrain_GUI()
        {
        }
        ...
        public override void OnGUI(MaterialEditor materialEditorIn, MaterialProperty[] properties)
        {
            ...
            //SRS
            InitCoverageGUI(materialEditorIn, properties);
            rainCoverageGUI.DrawCoverageGUI(materialEditorIn);
            //
