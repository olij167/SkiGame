...
namespace Artngame.SKYMASTER {
	...
	public class WaterHandlerSM : MonoBehaviour {
        ...
        //v5.2.2
        public float foamExtendOffset = 0;
			...
			if (cam_transf != null && cam_transf.position.y < this_transf.position.y && !DisableUnderwater) { //v3.3e
				...
				if(underWaterType == UnderWaterPreset.Custom){
					...
					if (cam_transf.position.y < this_transf.position.y-DepthFogSwitch) {
						...
						if(is_DayLight
							...
							oceanMat.SetVector("_InvFadeParemeter", Vector4.Lerp(Fades,new Vector4(Fade1 + ShoreBlendOffset,0.1594f + foamExtendOffset, 0.043f,change_to),222.57f * Time_delta * Sm_speed));//v3.4.7
						}else{
							Vector4 Fades = oceanMat.GetVector("_InvFadeParemeter");
							oceanMat.SetVector("_InvFadeParemeter", Vector4.Lerp(Fades,new Vector4(Fade1 + ShoreBlendOffset, 0.1594f + foamExtendOffset, 0.043f,1),22.57f * Time_delta * Sm_speed));//v3.4.7
						}
					}else{
						//if (SkyManager.Current_Time > (9 + SkyManager.Shift_dawn) & SkyManager.Current_Time <= (21.9f + SkyManager.Shift_dawn)
						if(is_DayLight
							...
							oceanMat.SetVector("_InvFadeParemeter", Vector4.Lerp(Fades,new Vector4(Fade2 + ShoreBlendOffset, 0.1594f + foamExtendOffset, 0.043f,Fade3),225.57f * Time_delta * Sm_speed));//v3.4.7
						}else{
							Vector4 Fades = oceanMat.GetVector("_InvFadeParemeter");
							//oceanMat.SetVector("_InvFadeParemeter", new Vector4(0.000016f,Fades.y,Fades.z,Fades.w));
							oceanMat.SetVector("_InvFadeParemeter", Vector4.Lerp(Fades,new Vector4(Fade2 + ShoreBlendOffset, 0.1594f + foamExtendOffset, 0.043f,1),222.57f * Time_delta * Sm_speed));//*2 //v3.4.7
						}
					}
					...
					if (cam_transf.position.y < this_transf.position.y-DepthFogSwitch) {
						...
						if(is_DayLight
							...
							oceanMat.SetVector("_InvFadeParemeter", Vector4.Lerp(Fades,new Vector4(Fade1 + ShoreBlendOffset, 0.1594f + foamExtendOffset, 0.043f,change_to),222.57f * Time_delta * Sm_speed));
						}else{
							Vector4 Fades = oceanMat.GetVector("_InvFadeParemeter");
							oceanMat.SetVector("_InvFadeParemeter", Vector4.Lerp(Fades,new Vector4(Fade1 + ShoreBlendOffset, 0.1594f + foamExtendOffset, 0.043f,1),22.57f * Time_delta * Sm_speed));
						}
					}else{
						//if (SkyManager.Current_Time > (9 + SkyManager.Shift_dawn) & SkyManager.Current_Time <= (21.9f + SkyManager.Shift_dawn)
						if(is_DayLight
							...
							Vector4 Fades = oceanMat.GetVector("_InvFadeParemeter");
							//oceanMat.SetVector("_InvFadeParemeter", Fades + new Vector4(0.000016f,0,0,0));
							oceanMat.SetVector("_InvFadeParemeter", Vector4.Lerp(Fades,new Vector4(Fade2 + ShoreBlendOffset, 0.1594f + foamExtendOffset, 0.043f,Fade3),225.57f * Time_delta * Sm_speed));
						}else{
							Vector4 Fades = oceanMat.GetVector("_InvFadeParemeter");
							//oceanMat.SetVector("_InvFadeParemeter", new Vector4(0.000016f,Fades.y,Fades.z,Fades.w));
							oceanMat.SetVector("_InvFadeParemeter", Vector4.Lerp(Fades,new Vector4(Fade2 + ShoreBlendOffset, 0.1594f + foamExtendOffset, 0.043f,1),222.57f * Time_delta * Sm_speed));
						}
					}
					...
					if (cam_transf.position.y < this_transf.position.y-DepthFogSwitch) {
						...
						if(is_DayLight
							...
							oceanMat.SetVector("_InvFadeParemeter", Vector4.Lerp(Fades,new Vector4(Fade1 + ShoreBlendOffset, 0.1594f + foamExtendOffset, 0.043f,Fade3),222.57f * Time_delta * Sm_speed));
						}else{
							Vector4 Fades = oceanMat.GetVector("_InvFadeParemeter");
							oceanMat.SetVector("_InvFadeParemeter", Vector4.Lerp(Fades,new Vector4(Fade1 + ShoreBlendOffset, 0.1594f + foamExtendOffset, 0.043f,Fade3),22.57f * Time_delta * Sm_speed));
						}
					}else{
						//if (SkyManager.Current_Time > (9 + SkyManager.Shift_dawn) & SkyManager.Current_Time <= (21.9f + SkyManager.Shift_dawn)
						if(is_DayLight
							...
							Vector4 Fades = oceanMat.GetVector("_InvFadeParemeter");
							//oceanMat.SetVector("_InvFadeParemeter", new Vector4(0.000016f,Fades.y,Fades.z,Fades.w));
							oceanMat.SetVector("_InvFadeParemeter", Vector4.Lerp(Fades,new Vector4(Fade2 + ShoreBlendOffset, 0.1594f + foamExtendOffset, 0.043f,Fade3),222.57f * Time_delta * Sm_speed));
						}
					}
				...
				if(1==1){
					...
					if(waterType == WaterPreset.Custom){
						...
						oceanMat.SetVector("_InvFadeParemeter", Vector4.Lerp(Fades,new Vector4(0.16f + ShoreBlendOffset, 0.1594f + foamExtendOffset, 0.043f,4.2f),110.27f * Time_delta * Sm_speed));
						...
						oceanMat.SetFloat ("_FresnelScale", Mathf.Lerp (oceanMat.GetFloat ("_FresnelScale"), 0.15f, 0.15f *Time_delta * Sm_speed));
						oceanMat.SetVector("_InvFadeParemeter", Vector4.Lerp(Fades,new Vector4(0.077f + ShoreBlendOffset, 0.1594f + foamExtendOffset, 0.043f,4.2f),110.27f * Time_delta * Sm_speed));
						...
						oceanMat.SetFloat ("_FresnelScale", Mathf.Lerp (oceanMat.GetFloat ("_FresnelScale"), 0.15f, 0.15f *Time_delta * Sm_speed));
						oceanMat.SetVector("_InvFadeParemeter", Vector4.Lerp(Fades,new Vector4(0.11f + ShoreBlendOffset, 6.3f + foamExtendOffset, 0.76f,-7.4f),110.27f * Time_delta * Sm_speed));
						...
						oceanMat.SetFloat ("_FresnelScale", Mathf.Lerp (oceanMat.GetFloat ("_FresnelScale"), 0.15f, 0.15f *Time_delta * Sm_speed));
						oceanMat.SetVector("_InvFadeParemeter", Vector4.Lerp(Fades,new Vector4(0.09f + ShoreBlendOffset, 0.1594f + foamExtendOffset, 0.043f,4.2f),110.27f * Time_delta * Sm_speed));
						...
						oceanMat.SetFloat ("_FresnelScale", Mathf.Lerp (oceanMat.GetFloat ("_FresnelScale"), 0.15f, 0.15f *Time_delta * Sm_speed));
						oceanMat.SetVector("_InvFadeParemeter", Vector4.Lerp(Fades,new Vector4(0.1f + ShoreBlendOffset, 0.1594f + foamExtendOffset, 0.043f,0.72f),110.27f * Time_delta * Sm_speed));
						...
						oceanMat.SetFloat ("_FresnelScale", Mathf.Lerp (oceanMat.GetFloat ("_FresnelScale"), 0.15f, 0.15f *Time_delta * Sm_speed));
						oceanMat.SetVector("_InvFadeParemeter", Vector4.Lerp(Fades,new Vector4(0.07f + ShoreBlendOffset, 0.15f + foamExtendOffset, 1.29f,4.2f),110.27f * Time_delta * Sm_speed));
						...
						oceanMat.SetVector("_InvFadeParemeter", Vector4.Lerp(Fades,new Vector4(0.21f + ShoreBlendOffset, 0.1594f + foamExtendOffset, 0.043f,4.2f),110.27f * Time_delta * Sm_speed));		//
						...
						oceanMat.SetVector("_InvFadeParemeter", Vector4.Lerp(Fades,new Vector4(0.034f + ShoreBlendOffset, 0.15f + foamExtendOffset, 0.043f,0.72f),110.27f * Time_delta * Sm_speed));
						...
						oceanMat.SetVector("_InvFadeParemeter", Vector4.Lerp(Fades,new Vector4(0.01f + ShoreBlendOffset, 0.04f + foamExtendOffset, 0.043f,0.7f),110.27f * Time_delta * Sm_speed));
						...
						oceanMat.SetVector("_InvFadeParemeter", Vector4.Lerp(Fades,new Vector4(0.034f + ShoreBlendOffset, 0.17f + foamExtendOffset, 0.043f,-18.5f),110.27f * Time_delta * Sm_speed));
