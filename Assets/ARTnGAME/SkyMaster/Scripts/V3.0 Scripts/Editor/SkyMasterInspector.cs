...
//				EditorGUILayout.EndHorizontal();
					...
					if (script.SkyManager != null) {
						...
						EditorGUILayout.BeginHorizontal ();
						script.SkyManager.Shift_dawn = EditorGUILayout.Slider (script.SkyManager.Shift_dawn, -3.5f, 1, GUILayout.MaxWidth (sliderWidth));//v5.1.5j -1.5f, 0,
                        EditorGUILayout.EndHorizontal ();
						...
						EditorGUILayout.BeginHorizontal ();
						script.SkyManager.max_moon_intensity = EditorGUILayout.Slider (script.SkyManager.max_moon_intensity, 0.01f, 3, GUILayout.MaxWidth (sliderWidth));
						EditorGUILayout.EndHorizontal ();
						...
						EditorGUILayout.BeginHorizontal ();
						script.SkyManager.Moon_glow = EditorGUILayout.Slider (script.SkyManager.Moon_glow, 0f, 20, GUILayout.MaxWidth (sliderWidth));
						EditorGUILayout.EndHorizontal ();
					...
					if (script.water_folder1) {
						...
						if (GUILayout.Button (new GUIContent ("Add Water"), GUILayout.Width (120))) {			
							...
							if (script.LargeWaterPlane) {
								...
								WaterTile1.transform.localScale = new Vector3 (StartScale.x * script.LargeWaterPlaneScale * 0.001f, StartScale.y, StartScale.z * script.LargeWaterPlaneScale * 0.001f);//v5.1.6 make plane smaller
								WaterTile1.transform.localPosition = Start_pos1;
						
								WaterTile1 = (GameObject)Instantiate (WaterTileLargePREFAB);
								WaterTile1.transform.parent = Water.transform;
								WaterTile1.transform.position = new Vector3 (Start_pos.x, Height + 3, Start_pos.z);
								WaterTile1.transform.localScale = new Vector3 (-StartScale.x * script.LargeWaterPlaneScale * 0.001f, StartScale.y, StartScale.z * script.LargeWaterPlaneScale * 0.001f);
								WaterTile1.transform.localPosition = Start_pos1 + new Vector3 (0.002f, 0, 0);//v5.1.6

                                WaterTile1 = (GameObject)Instantiate (WaterTileLargePREFAB);
								WaterTile1.transform.parent = Water.transform;
								WaterTile1.transform.position = new Vector3 (Start_pos.x, Height + 3, Start_pos.z);
								WaterTile1.transform.localScale = new Vector3 (StartScale.x * script.LargeWaterPlaneScale * 0.001f, StartScale.y, -StartScale.z * script.LargeWaterPlaneScale * 0.001f);
								WaterTile1.transform.localPosition = Start_pos1 + new Vector3 (0, 0, 0.002f);//v5.1.6

                                WaterTile1 = (GameObject)Instantiate (WaterTileLargePREFAB);
								WaterTile1.transform.parent = Water.transform;
								WaterTile1.transform.position = new Vector3 (Start_pos.x, Height + 3, Start_pos.z);
								WaterTile1.transform.localScale = new Vector3 (-StartScale.x * script.LargeWaterPlaneScale * 0.001f, StartScale.y, -StartScale.z * script.LargeWaterPlaneScale * 0.001f);
								WaterTile1.transform.localPosition = Start_pos1 + new Vector3 (0.002f, 0, 0.002f);//v5.1.6 - change 0.002 to 0.02
						...
						if (script.WaterManager != null) {
							...
							EditorGUILayout.BeginHorizontal ();
							script.WaterManager.BumpFocusOffset = EditorGUILayout.Slider (script.WaterManager.BumpFocusOffset, -15f, 15, GUILayout.MaxWidth (sliderWidth));//5.2.0f
                            EditorGUILayout.EndHorizontal ();
