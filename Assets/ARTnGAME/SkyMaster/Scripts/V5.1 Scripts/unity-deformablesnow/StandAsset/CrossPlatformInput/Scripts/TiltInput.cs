...
using Artngame.SKYMASTER.Utils.CrossPlatformInput.PlatformSpecific;

namespace Artngame.SKYMASTER.Utils.CrossPlatformInput
{
...
namespace Artngame.SKYMASTER.Utils.CrossPlatformInput.Inspector
{
#if UNITY_EDITOR
