...
namespace Artngame.SKYMASTER.EtherealVolumetrics
{
    public class SmokeVolume : LocalVolumetricFog
    {
        ...
        public override void SetComputeShaderProperties(CommandBuffer cmd, ComputeShader cs, int kernel)
        {
            ...
            cmd.SetComputeFloatParam(cs, IDs._SmokeCameraFarPlane, Camera.main.farClipPlane);
            cmd.SetComputeTextureParam(cs,0, "_InteractiveSmokeMask", mask);
            cmd.SetComputeTextureParam(cs, 0, "_MaskTexture", mask);
        }
