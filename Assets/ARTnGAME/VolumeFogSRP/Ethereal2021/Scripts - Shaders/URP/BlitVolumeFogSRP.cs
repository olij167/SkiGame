...
namespace Artngame.SKYMASTER // UnityEngine.Rendering.Universal// LWRP //v1.1.8n
{
    public class BlitVolumeFogSRP : UnityEngine.Rendering.Universal.ScriptableRendererFeature
    {
        ...
        RTHandle m_RenderTextureHandle;//v0.1
        ...
        public override void Create()
        {
           ...
           // blitPass.renderPassEvent = RenderPassEvent.AfterRenderingOpaques;
                                      ...
                                      in RenderingData renderingData)
        {
            if (renderingData.cameraData.cameraType == CameraType.Game)
            {
                ...
                blitPass.SetTarget(renderer.cameraColorTargetHandle, m_Intensity);
            }
        }
#endif
