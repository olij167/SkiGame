...
public class RainManager : MonoBehaviour {
		...
		Mesh CreateMesh () {
			...
			//v2.3
			//int particleNum = QualitySettings.GetQualityLevel() > 3 ? numberOfParticles : numberOfParticles / 2; //QualityManager.quality > Quality.Medium ? numberOfParticles : numberOfParticles / 2;
