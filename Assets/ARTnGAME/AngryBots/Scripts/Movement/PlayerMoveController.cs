...
namespace Artngame.PDM {
	public class PlayerMoveController : MonoBehaviour {
		...
		void Start () {
            ...
            //GUITexture guiTex = joystickRightGO.GetComponent<GUITexture> ();//v0.1
            Image guiTex = joystickRightGO.GetComponent<Image>();//v0.1
            //guiTex.pixelInset.x = Screen.width - guiTex.pixelInset.x - guiTex.pixelInset.width;

            //v0.1
            //guiTex.pixelInset = new Rect(Screen.width - guiTex.pixelInset.x - guiTex.pixelInset.width, guiTex.pixelInset.y, guiTex.pixelInset.width, guiTex.pixelInset.height);
#endif
