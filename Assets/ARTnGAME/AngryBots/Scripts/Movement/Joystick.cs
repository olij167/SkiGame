...
namespace Artngame.PDM {
	...
	public class Joystick : MonoBehaviour {
		...
		static private Joystick[] joysticks;					// A static collection of all joysticks
            ...
            private Image gui;//private GUITexture gui;								// Joystick graphic. //v0.1
#endif
		...
		gui = GetComponent<Image>();//GetComponent<GUITexture> ();//v0.1

            // Store the default rect for the gui, so we can snap back to it
            defaultRect = new Rect(10,10,10,10);// gui.pixelInset;//v0.1
        ...
        if (gui.mainTexture != null)//if (gui.texture) //v0.1
        ...
        void ResetJoystick () {
            ...
            //gui.SetClipRect(defaultRect, false);   //gui.pixelInset = defaultRect;//v0.1
                lastFingerId = -1;
        ...
        bool IsFingerDown(){ //function IsFingerDown () : boolean {
        ...
        void Update()
        {
            ...
            else
            {
                for (int i = 0; i < count; i++)
                {
                    ...
                    //else if (gui.HitTest(touch.position))//v0.1
                    //{
                    //    shouldLatchFinger = true;
                    //}
