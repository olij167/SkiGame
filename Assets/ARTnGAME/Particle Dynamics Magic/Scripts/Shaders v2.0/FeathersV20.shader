...
Shader "Particle Dynamic Magic/FeathersV20" {
    Properties {
   ...
   uniform float4 _LightColor0;
	...
	VertexOutput vert (VertexInput v) {
               ...
               float node_133 = pow((abs((frac((o.uv0+node_5027*float2(0.2,0.1)).r)-0.5))*2.0),_BulgeShape);
                ...
                if( o.uv0.y > 0.1){
                	v.vertex.xyz += (node_133*(_BulgeScale*sin(_TimeControl1.w*_Time.y +_TimeControl1.z) )*v.normal*(v.normal*_BulgeScale_copy));
