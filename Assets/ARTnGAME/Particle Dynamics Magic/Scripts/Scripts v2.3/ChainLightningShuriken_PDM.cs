...
public class ChainLightningShuriken_PDM : MonoBehaviour
{
				...
				if (target1 != null) {
					if (target1.Length > 0) {
						...
						if (target != null) {
							...
							//v1.4
							ChainLightningShuriken_PDM next_in_Chain = target.gameObject.GetComponent (typeof(ChainLightningShuriken_PDM)) as ChainLightningShuriken_PDM;
							//Energize target
							if (next_in_Chain == null) {

								next_in_Chain = target.gameObject.GetComponentInChildren (typeof(ChainLightningShuriken_PDM)) as ChainLightningShuriken_PDM;
