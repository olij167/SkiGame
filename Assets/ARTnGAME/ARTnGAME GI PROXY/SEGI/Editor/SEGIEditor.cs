...
namespace Artngame.SKYMASTER.SEGISRP
{
	...
	public class SEGIEditor : Editor
	{
		...
		SerializedProperty updateGIevery;
		...
		const string presetPath = "Assets/ARTnGAME/ARTnGAME GI PROXY/SEGI/Resources/Presets";//v4.2a
		...
		public override void OnInspectorGUI()
		{
			...
			if (showMainConfig)
			{
				...
				EditorGUILayout.PropertyField(updateGIevery, new GUIContent("Update Every", "Update rate optimization, Lower the rate the effect updates in run time"));
