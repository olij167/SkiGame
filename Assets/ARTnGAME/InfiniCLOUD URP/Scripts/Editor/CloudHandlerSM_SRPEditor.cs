...
namespace Artngame.SKYMASTER
{
    ...
    public class CloudHandlerSM_SRPEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            ///////////////////// CLOUD WIND /////////////////////  
            EditorGUILayout.HelpBox("----------------------------- CLOUD WIND ---------------------------", MessageType.None);
            EditorGUILayout.HelpBox("Control the wind powe of clouds. Use windzone rotation for wind direction.", MessageType.Info);

            clouds.setStartWind = EditorGUILayout.Toggle("Set start wind on play", clouds.setStartWind);
            clouds.WindStrength = EditorGUILayout.FloatField("Clouds wind power", clouds.WindStrength);
            clouds.WindParallaxFactor = EditorGUILayout.FloatField("Clouds wind turbulence", clouds.WindParallaxFactor);
