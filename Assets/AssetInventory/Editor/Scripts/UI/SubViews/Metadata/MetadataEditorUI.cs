...
namespace AssetInventory
{
    public sealed class MetadataEditorUI : BasicEditorUI
    {
        ...
        public override void OnGUI()
        {
            ...
            {
                _def.ValueList = GUIStringListField("Possible Values", _def.ValueList, newValue => _def.ValueList = newValue, ",", "Possible Values", labelWidth, "Possible values separated by comma");
            }
            ...
            {
                GUILayout.BeginHorizontal();
                EditorGUILayout.LabelField($"{CommonUIStyles.INDENT}Asset Source", EditorStyles.boldLabel, GUILayout.MaxWidth(labelWidth));
            ...
            {
                GUILayout.BeginHorizontal();
                EditorGUILayout.LabelField($"{CommonUIStyles.INDENT}Asset Group", EditorStyles.boldLabel, GUILayout.MaxWidth(labelWidth));
            ...
            */
            ...
            if (GUILayout.Button(_def.Id > 0 ? "Update" : "Create", CommonUIStyles.mainButton, GUILayout.Height(CommonUIStyles.BIG_BUTTON_HEIGHT)))
            {
