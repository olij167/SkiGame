...
namespace AssetInventory
{
    public sealed class FolderWizardUI : EditorWindow
    {
        ...
        public void OnGUI()
        {
            ...
            {
                EditorGUILayout.LabelField("Already Active", CommonUIStyles.centerLabel);
            }
            else
            {
            ...
            EditorGUILayout.Space();
            GUILayout.BeginHorizontal();
            if (GUILayout.Button("Add", CommonUIStyles.mainButton, GUILayout.Height(CommonUIStyles.BIG_BUTTON_HEIGHT))) SaveSettings();
            // if (GUILayout.Button("Refresh", GUILayout.Height(CommonUIStyles.BIG_BUTTON_HEIGHT), GUILayout.Width(80))) ParseFolder();
            GUILayout.EndHorizontal();
        ...
        private void ParseFolder()
        {
            ...
            List<AI.AssetGroup> mediaExt = new List<AI.AssetGroup>();
            mediaExt.AddRange(new[] {AI.AssetGroup.Audio, AI.AssetGroup.Images, AI.AssetGroup.Models});

            List<string> mediaTypes = new List<string>();
            mediaExt.ForEach(t => mediaTypes.AddRange(AI.TypeGroups[t]));

            string deRel = Paths.DeRel(_folder);
