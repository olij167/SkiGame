...
namespace RaycastPro.Editor
{
    ...
    public static class IconManager
    {
        ...
        public static Texture2D Header => AssetDatabase.LoadAssetAtPath<Texture2D>(RCProPanel.ResourcePath + (EditorGUIUtility.isProSkin ? "/RaycastPro_Header.png" : "/RaycastPro_Header_Light.png"));
