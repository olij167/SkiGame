namespace RaycastPro.Bullets
{
    ...
    public sealed class PathBullet : Bullet
    {
        ...
        [SerializeField] private AxisRun axisRun = new AxisRun();

        private float pathLength;

        [Tooltip("Track the source Path in real-time.")] [SerializeField]
        private bool live = true;

        [Tooltip("Considering the path according to the hit point.")] [SerializeField]
        ...
        internal override string Info =>
            "A sophisticated path-following projectile designed to travel along the trajectory defined by any 'PathRay' sensor. It dynamically constructs its route from the path points provided by the source sensor, including complex geometries generated by systems like the 'Planar Sensitive' modifiers. The bullet's progression along this path can be controlled by fixed speed, total duration, or a custom animation curve for advanced easing effects. It optionally supports 'live' path recalculation for dynamic environments and smoothly orients itself to match the path's direction during movement."
