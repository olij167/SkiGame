...
#if UNITY_EDITOR
        internal override string Info => "A volumetric sensor that identifies line-of-sight targets within an annular cylindrical area, defined by a height and both a minimum and maximum radius." + HIPulse + HCDetector + HLOS_Solver + HINonAllocator;
