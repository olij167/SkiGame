...
#if UNITY_EDITOR
        internal override string Info => "A box-shaped volumetric sensor that identifies all line-of-sight targets. The detection volume can be configured to operate as a world-aligned Axis-Aligned Bounding Box (AABB) or as a locally-oriented Oriented Bounding Box (OBB)."
