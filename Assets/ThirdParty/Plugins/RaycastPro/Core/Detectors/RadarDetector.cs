    ...
    public sealed class RadarDetector : ColliderDetector, IRadius
    {
        ...
        protected override void OnCast()
        {
                         ...
                         _t.rotation, radius, detectLayer.value, triggerInteraction))
            {
                ...
                if (collectLOSPoints) directLOSPoints.Add(tCollider, point);
...
#if UNITY_EDITOR
        internal override string Info => "Simulates a radar-style scanner, sweeping a vertical detection beam in a 360-degree arc. It caches line-of-sight targets, causing them to persist like a 'blip' on a radar screen before fading over time."
