...
#if UNITY_EDITOR
        internal override string Info => "An advanced avatar visibility assessor that determines a target's exposure level through probabilistic sampling. It repeatedly casts line-of-sight checks to random bones on the avatar's skeleton, aggregating the results into a smoothed visibility score (0-1) for a robust and realistic occlusion test."
                                         + HAccurate + HIPulse+HDependent+HPreview;
