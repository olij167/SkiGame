...
#if UNITY_EDITOR
        internal override string Info => "A paired portal modifier for the 'Planar Sensitive' ray system. It operates as an entry/exit point, instantly teleporting any incoming ray from its impact location to the position and orientation of a linked 'Exit Portal' component. This allows for the creation of non-Euclidean pathways and complex puzzle mechanics by routing rays through disconnected spaces."
                                          +HAccurate+HDependent+HExperimental;
