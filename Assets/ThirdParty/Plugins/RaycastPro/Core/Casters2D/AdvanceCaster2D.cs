...
#if UNITY_EDITOR
        internal override string Info => "An advanced implementation of the GunCaster framework, engineered for complex, multi-barrel or pattern-firing weapons. It accepts an array of RaySensors, enabling the simulation of firearms like shotguns, mini-guns, or missile pods. This caster features multiple firing patterns (e.g., 'Together', 'Sequence', 'Random') to control how projectiles are instantiated across the array of defined fire points, allowing for sophisticated and highly customizable weapon behaviors." + HAccurate + HDependent;
