...
#if UNITY_EDITOR
        internal override string Info => "A 2D arc sweep sensor that performs a fan-shaped series of linecasts within a configurable angle. Its primary function is to identify the single nearest obstacle across the entire swept area. Additionally, it calculates a normalized 'occlusion score' (0-1), representing the percentage of the arc that is obstructed by colliders. This provides a granular understanding of environmental openness, making it an ideal tool for sophisticated 2D AI to assess directional clearance or find the most open pathways."+ HAccurate + HDirectional;
