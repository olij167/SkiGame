...
#if UNITY_EDITOR
        internal override string Info => "Sweeps a raycast (or a spherecast if a radius is provided) across a defined arc, returning the hit information for the nearest object found." + HAccurate + HDirectional + HIRadius;
