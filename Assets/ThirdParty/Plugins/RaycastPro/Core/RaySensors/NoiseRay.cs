...
#if UNITY_EDITOR
        internal override string Info => "Periodically casts a ray from a fixed origin towards a random point on the circumference of a specified oval." + HIPulse + HAccurate + HDirectional;
