...
#if UNITY_EDITOR
        internal override string Info => "Performs an enhanced linecast between an origin and a target, where the ray can be truncated by a maximum distance, a normalized weight (0-1), or a fixed offset from the target." + HAccurate + HIRadius + HDependent;
