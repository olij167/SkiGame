namespace RaycastPro.RaySensors
{
    ...
    public sealed class ReflectRay : PathRay, IRadius
    {
        ...
        internal override string Info => "Casts a ray that sequentially reflects off surfaces on the <i>Reflect layer</i> until it strikes an object on the <i>Detect layer</i>, returning the final hit information." + HAccurate + HPathRay + HRecursive + HIRadius;
