...
#if UNITY_EDITOR
        internal override string Info => "A versatile collision checker that determines the presence of any colliders within a specified detection volume. It supports Sphere, Capsule, and Box shapes, returning a boolean (true/false) indicating if any object on the detect layer is currently overlapping the volume."
                                         + HUtility + HAccurate + HIRadius;
