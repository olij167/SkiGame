...
#if UNITY_EDITOR
        internal override string Info => "A companion visualizer component designed to render the output of RaycastPro sensors using a LineRenderer. It intelligently adapts to display both simple directional rays and complex, multi-point paths. Includes advanced options to automatically truncate the line at the point of impact, or to render only a specific 'clamped' sub-segment of the full ray or path geometry. Supports both 2D and 3D sensor types."+ HDependent + HUtility;
