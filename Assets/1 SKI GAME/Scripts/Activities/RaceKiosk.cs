...
public sealed class RaceKiosk : MonoBehaviour, IWorldInteractionPromptSource
{
    [Header("Input")]
    ...
    [SerializeField] private string promptText = "Open Race Signup";

    [Header("UI")]
    [SerializeField] private RaceSignupKioskUI kioskUI;
    ...
    {
        if (kioskUI == null)
            kioskUI = FindObjectOfType<RaceSignupKioskUI>(true);
    }
