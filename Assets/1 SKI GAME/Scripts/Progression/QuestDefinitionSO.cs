...
namespace SkiGame.Progression
{
    ...
    {
        AutoCompleteOnObjectivesMet = 0,
        RequireTurnIn = 10
    }

    public enum QuestTurnInTargetType
    {
        None = 0,
        OriginalQuestGiver = 10,
        SpecificNpcIdentity = 20,
        GenericNpcArchetype = 30,
        SceneMarker = 40,
        AutoGeneratedNearbyTarget = 50
    }
    ...
    public sealed class QuestDefinitionSO : ScriptableObject
    {
        ...
        public QuestCompletionMode completionMode = QuestCompletionMode.AutoCompleteOnObjectivesMet;
        public QuestTurnInTargetType turnInTargetType = QuestTurnInTargetType.None;
        public string turnInNpcIdentityId;
        public string turnInGenericArchetypeId;
        public string turnInLocationId;
        public bool turnInToOriginalQuestGiver;
    ...
    public static class QuestTextFormatter
    {
        public static string Format(
            ...
            QuestDefinitionSO questDefinition = null,
            QuestStageDefinition stageDefinition = null,
            QuestObjectiveDefinition objectiveDefinition = null,
            string npcName = null,
            NpcDialogueBubbleStyleSO style = null)
        {
            ...
            return NpcDialogueTextFormatter.Format(text, context, npcName, inputActions, style);
        }

        public static string FormatQuestTitle(QuestDefinitionSO definition, UnityEngine.InputSystem.InputActionAsset inputActions)
        {
            if (definition == null)
                return string.Empty;

            string raw = string.IsNullOrWhiteSpace(definition.title) ? definition.SafeId : definition.title;
            return Format(raw, inputActions, definition);
        }

        public static string FormatQuestDescription(QuestDefinitionSO definition, UnityEngine.InputSystem.InputActionAsset inputActions)
        {
            return definition == null ? string.Empty : Format(definition.description, inputActions, definition);
        }

        public static string FormatStageTitle(QuestDefinitionSO quest, QuestStageDefinition stage, int stageIndex, UnityEngine.InputSystem.InputActionAsset inputActions)
        {
            string raw = stage == null
                ? "Quest in progress"
                : string.IsNullOrWhiteSpace(stage.title) ? $"Stage {stageIndex + 1}" : stage.title.Trim();
            return Format(raw, inputActions, quest, stage);
        }

        public static string FormatStageDescription(QuestDefinitionSO quest, QuestStageDefinition stage, UnityEngine.InputSystem.InputActionAsset inputActions)
        {
            return stage == null ? string.Empty : Format(stage.description, inputActions, quest, stage);
        }

        public static string FormatObjectiveTitle(QuestDefinitionSO quest, QuestStageDefinition stage, QuestObjectiveDefinition objective, UnityEngine.InputSystem.InputActionAsset inputActions)
        {
            if (objective == null)
                return string.Empty;

            string raw = string.IsNullOrWhiteSpace(objective.title)
                ? objective.BuildAuthoringSummary()
                : objective.title.Trim();
            return Format(raw, inputActions, quest, stage, objective);
        }

        public static string FormatObjectiveDescription(QuestDefinitionSO quest, QuestStageDefinition stage, QuestObjectiveDefinition objective, UnityEngine.InputSystem.InputActionAsset inputActions)
        {
            return objective == null ? string.Empty : Format(objective.description, inputActions, quest, stage, objective);
        }
    }
}
