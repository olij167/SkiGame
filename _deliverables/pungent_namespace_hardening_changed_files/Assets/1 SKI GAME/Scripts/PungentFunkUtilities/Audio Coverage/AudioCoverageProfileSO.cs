...
namespace PungentFunk.Utilities.Audio
{
    ...
    public sealed class AudioCoverageProfileSO : ScriptableObject
    {
        ...
        public void ResetToGenericDefaults(bool clearExistingRules)
        {
            ...
            AddMissingDefaultBinding("UiOpen", "UI root / window controller", AudioBindingSourceKind.UnityEvent, "", "Open event", AudioPlaybackMode.PlayUi);
            AddMissingDefaultBinding("UiClose", "UI root / window controller", AudioBindingSourceKind.UnityEvent, "", "Close event", AudioPlaybackMode.PlayUi);
            AddMissingDefaultBinding("UiClick", "Button / selectable UI", AudioBindingSourceKind.UnityEvent, "UnityEngine.UI.Button", "onClick", AudioPlaybackMode.PlayUi);
            AddMissingDefaultBinding("UiBack", "UI navigation controller", AudioBindingSourceKind.UnityEvent, "", "Back event", AudioPlaybackMode.PlayUi);
            AddMissingDefaultBinding("UiNavigate", "UI navigation controller", AudioBindingSourceKind.UnityEvent, "", "Navigate event", AudioPlaybackMode.PlayUi);
            AddMissingDefaultBinding("UiAdjust", "Slider / settings UI", AudioBindingSourceKind.UnityEvent, "", "Value changed event", AudioPlaybackMode.PlayUi);
            AddMissingDefaultBinding("UiConfirm", "Confirmation UI", AudioBindingSourceKind.UnityEvent, "", "Confirm event", AudioPlaybackMode.PlayUi);
            AddMissingDefaultBinding("UiDeny", "Denied UI", AudioBindingSourceKind.UnityEvent, "", "Deny event", AudioPlaybackMode.PlayUi);

            AddMissingDefaultBinding("InteractionAccept", "Interaction prompt", AudioBindingSourceKind.CSharpEventViaAdapter, "", "Accepted", AudioPlaybackMode.PlayUi);
            AddMissingDefaultBinding("InteractionCancel", "Interaction prompt", AudioBindingSourceKind.CSharpEventViaAdapter, "", "Cancelled", AudioPlaybackMode.PlayUi);

            AddMissingDefaultBinding("PlayerDamage", "Character or health component", AudioBindingSourceKind.CSharpEventViaAdapter, "", "Damaged", AudioPlaybackMode.PlayAttached);
            AddMissingDefaultBinding("PlayerHeal", "Character or health component", AudioBindingSourceKind.CSharpEventViaAdapter, "", "Healed", AudioPlaybackMode.PlayAttached);
            AddMissingDefaultBinding("PlayerRespawn", "Character or spawn manager", AudioBindingSourceKind.CSharpEventViaAdapter, "", "Respawned", AudioPlaybackMode.PlayAttached);

            AddMissingDefaultBinding("Pickup", "Pickup or inventory component", AudioBindingSourceKind.CSharpEventViaAdapter, "", "Collected", AudioPlaybackMode.PlayAttached);
            AddMissingDefaultBinding("Checkpoint", "Checkpoint or progress trigger", AudioBindingSourceKind.CSharpEventViaAdapter, "", "Reached", AudioPlaybackMode.PlayWorld);
            AddMissingDefaultBinding("ObjectiveStart", "Objective/activity controller", AudioBindingSourceKind.CSharpEventViaAdapter, "", "Started", AudioPlaybackMode.PlayUi);
            AddMissingDefaultBinding("ObjectiveComplete", "Objective/activity controller", AudioBindingSourceKind.CSharpEventViaAdapter, "", "Completed", AudioPlaybackMode.PlayUi);
            AddMissingDefaultBinding("ObjectiveFail", "Objective/activity controller", AudioBindingSourceKind.CSharpEventViaAdapter, "", "Failed", AudioPlaybackMode.PlayUi);

            AddMissingDefaultBinding("DoorOpen", "Door or interactable component", AudioBindingSourceKind.CSharpEventViaAdapter, "", "Opened", AudioPlaybackMode.PlayWorld);
            AddMissingDefaultBinding("DoorClose", "Door or interactable component", AudioBindingSourceKind.CSharpEventViaAdapter, "", "Closed", AudioPlaybackMode.PlayWorld);
            AddMissingDefaultBinding("AmbientStinger", "Ambient event source", AudioBindingSourceKind.ManualCoverageOnly, "", "Manual trigger", AudioPlaybackMode.PlayWorld);
